          ...
          <div class="container-fluid pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-round btn-sm mb-0 btn-outline-dark me-2" target="_blank" href="#">Premium Service</a>
              </li>
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="#" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-warning">VIP</a>
                </li>
              </ul>
            </div>
          </div>
...
if(isset($_POST['email'])) {
    ...
    // echo $result['password']. "   ".$password;die;
    $yesOrNo = password_verify($password, $result['password']);
    ...
    if($yesOrNo) {
      echo"login Succeded";
        ...
        echo "<p class=' text-danger text-center m-3'><b>Failed to Log in</b></p>";
    }
    if($yesOrNo == true) {
