...
if(isset($_POST['username'])) {
    ...
    if(createuser($username, $email, $password, $img, $about))
        header("Location:login.php");
    else
    echo "<p class='text-danger'>Error creating user. Please try again.</p>";
}
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <a class="btn btn-round btn-sm mb-0 btn-outline-light me-2" target="_blank" href="#">Premium Service</a>
        </li>
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
          <a href="#" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-primary">VIP</a>
          </li>
        </ul>
      </div>
    </div>
              ...
              <div class="card-body">
                <form role="form text-left" method="POST" enctype="multipart/form-data">
                  ...
                  <label for="">About</label>
                    <input type="text" class="form-control" placeholder="About" aria-label="About" aria-describedby="About-addon" name="about" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="text-center">
                    <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</input>
                  </div>
