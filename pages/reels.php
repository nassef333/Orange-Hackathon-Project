        ...
        <div class="container">
            <div class="row g-4">
                ...
                <!-- Sidenav END -->
                                ...
                                <a href="uploadpublic.php" class="card card-body" style="background-image: url('../assets/img/back.webp');">
                    ...
                    // var_dump($restaurants);die;
                        ...
                        if(isset($_POST['search'])){
                            $reels = filterByAddress($_POST['search']);
                            // echo "<pre>";
                            // var_dump($restaurants);die;
                        }
                        else
                            $reels = showAllReelsInDB();
                    ...
                    <div class="card">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="nav nav-divider">
                                            ...
                                            <h6 class="nav-item card-title mb-0"> <a href="#!"><?=$user['username']?></a> <?="  -->"?> <a href="restaurant.php?id=<?=$reel[2]?>"> <?= fitchRestaurant($reel[2])[0][2]  ?> </a></h6>
                                            <span class="nav-item small  text-success"><?=fitchRestaurant($reel[2])[0][5]?></span>
                                        </div>
                                        <p class="mb-0 small"><?=$reel[6]?></p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-0">
                            <ul class="nav nav-stack py-3 small">
                                <li class="nav-item">
                                    <a class="nav-link" href="like.php?id=<?=$reel[0]?>"> <i class="bi bi-hand-thumbs-up-fill pe-1"></i>Likes (<?=$likesCnt?>)</a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="hstack gap-2 mb-3">
                                        ...
                                        <?php if(isFollowed($_SESSION['login']['id'],$user[0])):?>
